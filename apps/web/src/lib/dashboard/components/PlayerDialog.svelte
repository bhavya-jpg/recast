<script lang="ts">
	...
	import { RecastPlayer, type RecastPlayerEngagement } from "@recast/player";
	...
	let {
		...
		onclose: () => void;
		/**
		 * Forwarded straight from the underlying RecastPlayer. The dashboard
		 * recasts page latches `view-start` into the local recasts store
